...
Вы использовали все доступные бесплатные запросы.

Готовы к следующему шагу в карьере?
Получите расширенный доступ к продуктовым кейсам от Яндекса, Тинькофф и Авито с Pro-планом.
✅ Персонализированный фидбек по вашим решениям
✅ Эксклюзивные кейсы от топовых компаний
✅ Отработка продуктовых фреймворков на практике
Pro-план: всего 2990 рублей/месяц`,
    {
      reply_markup: {
        inline_keyboard: [
          [{ text: 'Инвестируйте в карьеру сейчас →', callback_data: 'payment_subscription' }]
        ]
      }
    }
  );
